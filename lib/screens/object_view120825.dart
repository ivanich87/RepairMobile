...
class scrObjectsViewScreen120825 extends StatefulWidget {
  final String id;
  scrObjectsViewScreen120825({super.key, required this.id});

  @override
  State<scrObjectsViewScreen120825> createState() => _scrObjectsViewScreen120825State();
}

class _scrObjectsViewScreen120825State extends State<scrObjectsViewScreen120825> with SingleTickerProviderStateMixin {
