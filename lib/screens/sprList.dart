        ...
        ListView.builder(
          ...
          floatingActionButton: (Globals.anUserRoleId!=3) ? null : FloatingActionButton(
            onPressed: () async{
              ...
              if (widget.sprName=='Сотрудники' || widget.sprName=='Контрагенты' || widget.sprName=='КонтрагентыДляФондов' || widget.sprName=='КлиентыКонтрагенты') {
                ...
                sprList _newSpr = sprList('', '', '', _newCode, false, false);
